...
var documents = [{
    ...
    "title": "Home",
    "body": "                                                                                               Les Ambassadeurs, the first Restaurant we Visited in Paris                         1 2 3 4 5                      :       Within the Hôtel de Crillon, which was built in 1758, Les Ambassadeurs operated as a restaurant since the mid-19th century. It reached its peak of fame as a restaurant and. . . :                                                                               Sal                 02 Feb 2020                                                                                                                           Much more than a desert: A trip into the Sahara              :       The Sahara is a desert located on the African continent. It is the largest hot desert in the world, and the third largest desert overall after Antarctica and the Arctic. . . . :                                                                               John                 01 Feb 2020                                                                                                                           One day we just started our adventure              :       The die cut has also been employed in the non-juvenile sphere as well, a recent example being Jonathan Safran Foer’s ambitious Tree of Codes. :                                                                               Sal                 12 Jan 2020                                                                                                                           London is that kind of place you must visit in this lifetime              :       The Queen’s Guard and Queen’s Life Guard (called King’s Guard and King’s Life Guard when the reigning monarch is male) are the names given to contingents of infantry and cavalry. . . :                                                                               John                 12 Jan 2020                                                                                                                           Memoirs supports external images as featured              :       Adding images is a very annoying task, I know that, but “Memoirs” theme has external featured images integrated so your publishing task becomes easier now. :                                                                               Sal                 12 Jan 2020                                                                                                                           Spoliers Inside - a film review needs hidden spoilers like this post              :       Director Roland Suso Richter’s enigmatic psychological thriller (direct to video/DVD) was based upon screenwriter Michael Cooney’s own play “Point of Death” - a title that gave away the film’s entire. . . :                                                                               John                 11 Jan 2020                                   &laquo;        1        2       &raquo; "
    }, {
    "id": 5,
    ...
    "id": 7,
    "url": "http://localhost:4000/jekyll-theme-memoirs/les-ambassadeurs/",
    ...
    "id": 8,
    "url": "http://localhost:4000/jekyll-theme-memoirs/much-more-than-a-desert-trip-to-sahara/",
    ...
    "id": 9,
    "url": "http://localhost:4000/jekyll-theme-memoirs/one-day-just-started-adventure/",
    ...
    "id": 10,
    "url": "http://localhost:4000/jekyll-theme-memoirs/london/",
    ...
    "id": 11,
    "url": "http://localhost:4000/jekyll-theme-memoirs/external-featured-image/",
    ...
    "id": 12,
    "url": "http://localhost:4000/jekyll-theme-memoirs/post-with-spoiler/",
    ...
    "id": 13,
    "url": "http://localhost:4000/jekyll-theme-memoirs/that-day-we-almost-missed-flight/",
    ...
    "id": 14,
    "url": "http://localhost:4000/jekyll-theme-memoirs/review-oscar/",
    ...
    "id": 15,
    "url": "http://localhost:4000/jekyll-theme-memoirs/french-wine/",
    ...
    "id": 16,
    "url": "http://localhost:4000/jekyll-theme-memoirs/the-observer/",
    ...
    "id": 17,
    "url": "http://localhost:4000/jekyll-theme-memoirs/press-and-education/",
    ...
    "id": 18,
    "url": "http://localhost:4000/jekyll-theme-memoirs/education/",
